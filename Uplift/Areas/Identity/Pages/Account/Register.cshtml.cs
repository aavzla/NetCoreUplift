...
namespace Uplift.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //Add To register new properties into ApplicationUser Model
            [Required]
            ...
            //Add missing Property from AspNetUsers
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    EmailConfirmed = true   //If the email is not confirmed, the login of the user will fail. This line was added, not included in the online course.
                };
                ...
                if (result.Succeeded)
                {
                    ...
                    //THe register of a new user will be only for Admin users. We do not need send an confirmation email.
                    ...
                    {
                        //After an Admin user register a new user, we do not need to change user with the new user.
